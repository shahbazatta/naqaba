        ...
        <div class="trackingCom">
            ...
            <div class="popMenuBox" id="trackingComBox">
                <div class="searchBoxForMenu">
                    <input type="text" onkeyup="trackingDevicesSearchEvent('trackingComSearch',1)"
                           name="trackingComSearch" id="trackingComSearch"
                           placeholder="<?php echo $localizedStrings->String($localizedStrings::LC_EN, 'SearchCompany'); ?>"
                           class="search">
...
=======
                <div class="headerList">
                    ...
                    <div class="close" onclick="closeFilterOnClose('trackingComBox','trackingComBoxImg')"><img
                            src="assets/images/icons/close.svg"></div>
                    <div class="selectAllCheckBox">
                        <label class="cCheckBox2">
                            <input type="checkbox" onclick="onSelectAllCheckBox('trackingComSeAl',1)"
                                   id="trackingComSeAl" name="trackingComSeAl" checked value="true">
                            <span class="checkmark"></span>
                        </label>
                        <label for="trackingComSeAl"
                               class="lebelText"><?php echo $localizedStrings->String($localizedStrings::LC_EN, 'SelectAll'); ?></label>
                    </div>
                </div>
>>>>>>> Stashed changes
        ...
        <div class="transportationCom">
            ...
            <div class="popMenuBox" id="transportationComBox">
                <div class="searchBoxForMenu">
                    <input type="text" onkeyup="trackingDevicesSearchEvent('transportationComSearch',2)"
                           name="transportationComSearch" id="transportationComSearch"
                           placeholder="<?php echo $localizedStrings->String($localizedStrings::LC_EN, 'SearchCompany'); ?>"
                           class="search">
                    <button type="button" class="searchButton"><img src="assets/images/icons/search.svg"></button>
                </div>
                <div class="headerList">
                    ...
                    <div class="close" onclick="closeFilterOnClose('transportationComBox','transportationComBoxImg')">
                        <img src="assets/images/icons/close.svg"></div>
                    <div class="selectAllCheckBox">
                        <label class="cCheckBox2">
                            <input type="checkbox" onclick="onSelectAllCheckBox('transportationComSeA1',2)"
                                   id="transportationComSeA1" name="transportationComSeA1" checked value="true">
                            <span class="checkmark"></span>
                        </label>
                        <label for="transportationComSeA1"
                               class="lebelText"><?php echo $localizedStrings->String($localizedStrings::LC_EN, 'SelectAll'); ?></label>
                    </div>
                </div>
...
=======
                <!--Transportaion list-->
                <div class="mainListRows newScrollBar" style="overflow-y:scroll;"
                     id="mainListRowsTransportationCompanies">
>>>>>>> Stashed changes
        ...
        <div class="trackingDevices">
            <a href="javascript:void(0)" id="trackingDevicesBoxShowImg"><img
                    src="assets/images/icons/truck_fast.svg"></a>

            <div class="popMenuBox" id="trackingDevicesBox">
                <div class="searchBoxForMenu">
                    <input type="text" name="trackingDevicesSearch" value=""
                           onkeyup="trackingDevicesSearchEvent('trackingDevicesSearch',3)" id="trackingDevicesSearch"
                           placeholder="<?php echo $localizedStrings->String($localizedStrings::LC_EN, 'SearchDevice'); ?>"
                           class="search">
                    <button type="button" class="searchButton"><img src="assets/images/icons/search.svg"></button>
                </div>
                <div class="headerList">
                    <h1><?php echo $localizedStrings->String($localizedStrings::LC_EN, 'trackingDevices'); ?></h1>
                    <div class="close" onclick="closeFilterOnClose('trackingDevicesBox','trackingDevicesBoxShowImg')">
                        <img src="assets/images/icons/close.svg"></div>
                    <div class="selectAllCheckBox">
                        <label class="cCheckBox2">
                            <input type="checkbox" onclick="onSelectAllCheckBox('trackingDevicesSeAl',3)"
                                   id="trackingDevicesSeAl" name="trackingDevicesSeAl" checked value="">
                            <span class="checkmark"></span>
                        </label>
                        <label for="trackingDevicesSeAl"
                               class="lebelText"><?php echo $localizedStrings->String($localizedStrings::LC_EN, 'SelectAll'); ?></label>
                    </div>
                </div>
...
>>>>>>> Stashed changes
        ...
        <div class="busFinder">
            ...
            <div class="popMenuBox busFinderBox" id="busFinderBox">
                <div class="searchBoxForMenu">
                    <input type="text" onkeyup="trackingDevicesSearchEvent('busListSearch',4)" name="busListSearch"
                           id="busListSearch"
                           placeholder="<?php echo $localizedStrings->String($localizedStrings::LC_EN, 'SearchIMEINumber'); ?>"
                           class="search">
                    <button type="button" class="searchButton"><img src="assets/images/icons/search.svg"></button>
                </div>
        ...
        <div class="geofences">
            ...
            <div class="popMenuBox geofencesBox" id="geofencesBox">
                <div class="searchBoxForMenu">
                    <input type="text" onkeyup="geofenceSearchEvent('geofenceSearch','geofencesTable')"
                           name="geofenceSearch" id="geofenceSearch" placeholder="Search Geofence" class="search">
                    <button type="button" class="searchButton"><img src="assets/images/icons/search.svg"></button>
                </div>
        ...
        <div class="settings">
            ...
            <div class="settingBox" id="settingBox">
                ...
                <div class="rowDropdown">
                    <div class="selectParent">
                        ...
                        <select id="bmap" class="bgSelect" title="Basemap">
                            <option
                                value="1"><?php echo $localizedStrings->String($localizedStrings::LC_EN, 'googleMap'); ?></option>
                            <option
                                value="0"><?php echo $localizedStrings->String($localizedStrings::LC_EN, 'openStreetMap'); ?></option>
                            <option value="2"
                                    selected><?php echo $localizedStrings->String($localizedStrings::LC_EN, 'mapBox'); ?></option>
                            <option
                                value="3"><?php echo $localizedStrings->String($localizedStrings::LC_EN, 'satelliteMap'); ?></option>
                        </select>
                    </div>
                </div>
                ...
                <div class="rowDropdown">
                    <div class="selectParent">
                        ...
                        <select id="setLanguage" name="setLanguage" class="bgSelect" title="Basemap">
                            <option value="ar" <?php if ($lang_type == 'ar') {
                                echo 'selected';
                            } ?> ><?php echo $localizedStrings->String($localizedStrings::LC_EN, 'arabic'); ?></option>
                            <option value="en" <?php if ($lang_type == 'en') {
                                echo 'selected';
                            } ?> ><?php echo $localizedStrings->String($localizedStrings::LC_EN, 'english'); ?></option>
                        </select>
                    </div>
                </div>
                ...
                <!--Select Transparency-->
                <div class="rowDropdown">
                    <h2><?php echo $localizedStrings->String($localizedStrings::LC_EN, 'transparency'); ?>
                        <output for="opacity-slider" id="slider-value">1</output>
                    </h2>
                    <div class="transparency">
                        <div class="sliderWrapper">
                            <input type="range" class="slider" min="0" max="1" value="1" id="opacity-slider"
                                   step="0.01">
                ...
                <div class="applySetting">
                    <button type="button" class="applySettingBtn"
                            id="applySettingBtn"><?php echo $localizedStrings->String($localizedStrings::LC_EN, 'apply'); ?></button>
                </div>
        ...
        <div id="activeDGF"><a href="javascript:void(0)" id="draw_geofence"><img src="assets/images/icons/pen_tool.svg"></a>
        </div>
        <div id="deactiveDGF"><a href="javascript:void(0)" id="de_draw_geofence"><img
                    src="assets/images/icons/close.svg"></a></div>
        <div id="activeGeoAna"><a href="javascript:void(0)" id="draw_geofence_ana"><img
                    src="assets/images/icons/geo_ana.svg"></a></div>
...
<div class="animationPanel" id="animationPanel">
    ...
    <div class="animHeader">
        ...
        <button type="button" class="closeBtn" id="closeBtn" onclick="closeAnimationPanel()"><img
                src="assets/images/icons/close.png"> Close
        </button>
        <button type="button" class="hideBtn" id="hideBtn" onclick="hideAnimationPanel()"><img
                src="assets/images/icons/screenmirroring.png"> Hide
        </button>
    </div>
    ...
    <div class="animBody">
      ...
      <span class="animBarFill">
        <input type="range" min="0.00" max="100.00" value="0" step="0.01" class="animation-slider"
    ...
    <div class="animControl">
        <button type="button" class="speedBtn" id="speedBtn" onclick="setSpeed()"><img
                src="assets/images/icons/speedometer.png"> Speed
        </button>
        ...
        <button type="button" class="resetBtn" id="resetBtn" onclick="resetAnimation()"><img
                src="assets/images/icons/refresh.png"> Reset
        </button>
    </div>

</div>
<button type="button" class="animationRestoreBtn" id="animationRestoreBtn" onclick="showAnimationPanel()"><img
        src="assets/images/icons/animation16.png"> Animation Restore
</button>
